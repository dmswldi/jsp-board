...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="${root }/index.jsp">게시판</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto"> <%-- mr-auto: 최대 너비 가짐 --%>
      ...
      <li class="nav-item">
        <a class="nav-link" href="${root }/article/write.do"><i class="fas fa-pen-alt"></i> 글 쓰기 </a> <%-- 로그인 후 글쓰기 화면으로 자동 이동하게 변경!!!@@@@ --%>
      </li>
      <u:isLogin>
	      <li class="nav-item">
	        <a class="nav-link" href="${root }/article/mylist.do"><i class="fas fa-list"></i> 내 글 보기 </a>
	      </li>
      </u:isLogin>
    </ul>
    ...
    <u:isLogin>
    	<ul class="navbar-nav">
	    	...
	    	<li class="nav-item"><a href="${root }/changePwd.do" class="nav-link">암호변경</a></li>
